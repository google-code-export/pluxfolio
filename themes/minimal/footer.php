<div id="footer">
	<?php echo $SITE_footer.'<a href="rodriges.org">minimal</a> (inspired by <a href="http://www.mnimal.com/">mnimal</a>)</p>'; if ($plxShow->plxMotor->maintence==1 && isset($_COOKIE["PHPSESSID"])) echo '<span style="color:red">'.$SITE_maintence_label.'</span>'; ?></div>

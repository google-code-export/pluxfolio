...
<form action="parametres_affichage.php" method="post" id="change-cf-file">
	<fieldset class="withlabel">
		...
		<p class="field"><label><?php echo $ADM_images_caption; ?>?</label></p>
		<?php plxUtils::printSelect('image_caption', $counter, $plxAdmin->aConf['image_caption']); ?>
		<p class="field"><label><?php echo $ADM_images_order; ?>:</label></p>
		<?php plxUtils::printSelect('imgorderby', $imgorder_by, $plxAdmin->aConf['imgorderby']); ?>

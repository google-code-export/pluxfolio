...
$SITE_maintence_label = '<font color="red">Режим заглушки</font>';
...
<h3>Добавление описания к картинкам в галереях <font color="red">NEW!</font></h3>
...
<h3>Чтобы вывести галерею на главной странице сайта</h3>
...
$ADM_contentsettings_thumboffest = 'Смещение миниатюры';
$ADM_contentsettings_thumboffesthelp = 'Удалите все файлы с расширением <b>.tb</b> после изменения';

...
class plxAdmin extends plxMotor {
	...
	/**
	 * Méthode qui édite le fichier XML e configuration selon le tableau $global et $content
	 *
	...
	/**
	 * Méthode qui parse le fichier des mots de passe
	 *
	 * @param	filename	emplacement du fichier XML des passwd
	 * @return	array	tableau login mot de passe array(login) = mdp(md5)
	 * @author	Florent MONTHEL
	 **/
	...
	/**
	 * Méthode qui édite le fichier XML du rédacteur (password+login) selon le tableau $content
	 *
	 * @param	content	tableau des informations sur le rédacteur
	 * @return	string
	 * @author	Florent MONTHEL
	 **/
...
return TRUE;  
	...
	/**
	 * Méthode qui lit le fichier d'une page galerie
	 *
	 * @param	num	numero du fichier de la page galerie
	 * @return	string	contenu de la page
	 * @author	Stephane F.
	 **/
	...
	/**
	 * Méthode qui sauvegarde le contenu d'une page galerie
	 *
	 * @param	content	données à sauvegarder
	 * @return	string
	 * @author	Stephane F. et Florent MONTHEL

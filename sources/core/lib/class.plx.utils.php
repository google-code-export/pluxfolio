...
return strtr($str, $tbl);
	...
	function makeThumb($filename, $filename_out, $width, $height, $quality, $offset, $thumbtype) {
		...
		if($thumbtype == 1) imagecopy($image_p, $image, 0, 0, $offset, $offset, $width, $height); // this do magic

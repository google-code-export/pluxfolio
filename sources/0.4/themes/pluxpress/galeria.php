...
$jpg_quality="75"; // JPG thumb quality, does not work for png or gif. 0 to 100.
			...
			If((!eregi(".tb",$file)) && (in_array(file_ext($file),$show_files))) {
				...
				If(!eregi($ignore_word,$file)) {
					...
					If($auto_thumb) {
						...
						plxUtils::makeThumb($full_server.$file, $full_server.$file.'.tb',$thumb_width,$thumb_height,$jpg_quality);	
						}
					}

...
if ($plxMotor->get =='')
	...
	if ($plxMotor->index_get == 0 || !isset($plxMotor->aGals[$plxMotor->index_get])) $plxMotor->get ='';
		else $plxMotor->get = 'galeria'.intval($plxMotor->index_get).'/'.$plxMotor->aGals[$plxMotor->index_get]['url'];
	}
...
$plxMotor->prechauffage();
	...
	//|| !isset($plxMotor->aGals[$plxMotor->cible])
//echo $plxMotor->aConf['galerie'];
/*
$plxMotor->mode = 'galeria';
$plxMotor->cible = '001';
$plxMotor->bypage = NULL;
$url = $plxMotor->aGals[$plxMotor->cible]['url'];
$plxMotor->get = 'galeria1/'.$url;
*/

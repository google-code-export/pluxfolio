...
<?php } else { # On a des documents
	...
	for($i=0; $i < $nb; $i++) { ?>
		<tr class="line-<?php echo $i%2; ?>">
			...
			<td class="tc1">&nbsp;
				<a href="<?php echo PLX_ROOT.$plxAdmin->aConf['documents'].plxUtils::strCut($aDoc[$i],100); ?>"><img src="img/anchor.png" /></a> <a href="documents.php?del=<?php echo $i.'&amp;hash='.$_SESSION['hash'] ?>" title="удалить файл с сайта" onClick="Check=confirm('<?php echo $ADM_check_deletion; ?>');if(Check==false) return false;"><img src="img/delete.png" /></a>
			</td>
        </tr>

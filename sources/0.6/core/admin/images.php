		...
		<?php
			if(!$aImg) { # Aucune image
				...
				for($i=0; $i < $nb; $i++) 
					...
					echo '<a href="'.$dirImg.$aImg[$i].'"><img src="img/anchor.png" /></a> <a href="'.$dirImg.$aImg[$i].'"><img src="img/download.png" /></a> <a href="?folder='.$folder.'&del='.$i.'&amp;hash='.$_SESSION['hash'].'" onclick="Check=confirm(\''.$ADM_check_deletion.'\');if(Check==false) return false;"><img src="img/delete.png" /></a></p>';
					echo '</div>'."\n";
					}
			}
		?>

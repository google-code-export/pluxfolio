...
<form action="parametres_affichage.php" method="post" id="change-cf-file">
	<fieldset class="withlabel">
		...
		<?php plxUtils::printInput('twitter', $plxAdmin->aConf['twitter'], 'text', '10-10'); echo '<i>'.$ADM_twitter_translationhelp.'</i>'; ?>
		...
		<p class="field"><label><?php echo $ADM_contentsettings_thumboffest; ?>:</label></p>
		<?php plxUtils::printInput('toffset', $plxAdmin->toffset, $type='text', $size='10-4'); ?> <?php echo $ADM_contentsettings_thumboffesthelp; ?>.
		<?php }; ?>

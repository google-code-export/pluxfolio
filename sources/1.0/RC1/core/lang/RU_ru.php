...
<h3>Добавление описания к картинкам в галереях <span style="color:red;">NEW!</span></h3>
<p>Если вы хотите видеть описание картинок в галерее вместо имен файлов, просто переименуйте файлы в соответствии с приведенным шаблоном, используя "!" как разделитель: <i>%имя%</i>!<i>%описание%</i>.jpg (или .png, или .gif) заменяя пробелы знаком подчеркивания ( _ ).<br><b>Пример:</b> Летний_луг!Это_-_фотография_луга_рядом_с_моим_домом.png</p>
...
$ADM_contentsettings_watermarkhelp = 'Водяной знак не может быть убран после создания. <a href="remove_tb.php">Удалите</a> все файлы с расширением <b>.tb</b>, чтобы пометить старые файлы. Замените файл <b>font.ttf</b> в директории /js вашим, чтобы изменить шрифт водяного знака.';
...
$SITE_footer = '<p><a href="core/admin/">Админка</a> | Движок: <a href="http://kkirill.com/">Кирилл Кузнецов</a>, шаблон: <a href="http://rodriges.org/">pluxpress</a>.</p>';

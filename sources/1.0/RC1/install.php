...
# Getting pretty output 
$mquotes = get_magic_quotes_gpc();
if($mquotes=='1') $mquotes = '<span style="color: green;">OK</span>';
else $mquotes = '<span style="color: red;">!!!</span>';if (!function_exists("gd_info")) {	$gdcheck = '<span style="color: red;">!!!</span>';} else {	$gdcheck = '<span style="color: green;">OK</span>';}
...
<ul>
	...
	<li><?php echo $INST_magicquotes_settings.': '.$mquotes; ?></li>		<li><?php echo $INST_gd_check.': '.$gdcheck;?></li>

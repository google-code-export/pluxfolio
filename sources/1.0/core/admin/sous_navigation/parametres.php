...
<?php if ($plxAdmin->aConf['admin_conf']==0) { ?>
	...
	<li><a href="parametres_avances.php" id="link_config"><?php echo $ADM_nav_sitepaths_title; ?></a></li>
	<li><a href="parametres_infos.php" id="link_info"><?php echo $ADM_nav_info_title; ?></a></li>
<?php }; ?>
</ul>
